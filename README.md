...
A simple chatbot built on AWS Lex that allows users to order pizza and drinks. This tutorial demonstrates step-by-step how to create a conversational AI bot using AWS Lex, with natural language understanding powered by machine learning.
